...
# train a model using the training data, in this case linear regression selected

lin_reg = LinearRegression()
lin_reg.fit(train_set, train_set_y)

# make predictions using the test set

y_train_pred = lin_reg.predict(train_set)
y_test_pred = lin_reg.predict(test_set)

# create joblib for model

dump(lin_reg, 'model1.joblib')
